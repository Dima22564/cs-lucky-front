      ...
      <div class="cs-lucky-row">
        <div class="stats-content">
          ...
          <div class="stats__linesWrapper">
            <div class="stats__bg" />
            <div class="stats__lines" v-if="game">
              <History
                v-for="bet in game.bets"
                :key="bet.id"
                :cost="bet.bank"
                :cost2="bet.winBank"
                :coeff="bet.multiplier"
                :items="bet.items"
                :avatar="bet.user.avatar"
                :is-win="bet.isWin"
                :win-item="bet.winItem"
              />
            </div>
          </div>
          <Footer />
...
export default {
  ...
  async mounted () {
    ...
    try {
      const result = await this.$store.dispatch('game/index', this.$route.params.id)
      console.log(result)
